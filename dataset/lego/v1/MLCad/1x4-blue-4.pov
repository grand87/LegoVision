...
#declare LDXMaxY = -8;
#declare LDXMaxZ = 10;
#declare LDXCenterX = 50;
#declare LDXCenterY = -100;
#declare LDXCenterZ = 0;
#declare LDXCenter = <LDXCenterX,LDXCenterY,LDXCenterZ>;
#declare LDXRadius = 43.543083;

// Camera settings
#declare LDXCameraLoc = < -30,-135.783569,0.000001 >;	// Camera Location vector
#declare LDXCameraLookAt = < -30,3.27461165895164185713,0.00000135685536406527 >;	// Camera look-at point vector
#declare LDXCameraSky = < 0,0,1 >;	// Camera sky vector (<0,-1,0> will usually work for standard "up")
