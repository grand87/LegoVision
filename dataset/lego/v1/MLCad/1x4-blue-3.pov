...
// Camera settings
#declare LDXCameraLoc = < -30.134056,-103.134621,-79.773773 >;	// Camera Location vector
#declare LDXCameraLookAt = < -29.97639040622108552725,-7.71047120207163061423,14.04985414306781876803 >;	// Camera look-at point vector
#declare LDXCameraSky = < 0.00119825995518860889,-0.70110199378622406474,0.71305999641128470223 >;	// Camera sky vector (<0,-1,0> will usually work for standard "up")
