...
// Camera settings
#declare LDXCameraLoc = < 100.702194,-308.831482,-126.801811 >;	// Camera Location vector
#declare LDXCameraLookAt = < -33.44341451948378107772,-14.44328480247969537231,3.34065121606360548867 >;	// Camera look-at point vector
#declare LDXCameraSky = < -0.6059320548803638351,-0.5359839779121081671,0.58784991306452738513 >;	// Camera sky vector (<0,-1,0> will usually work for standard "up")
